package com.example.uplabdhisingh.cryptocurrency.model;
...
public class CryptoDetails
{
         ...
         * @param priceUsd
         */
        public CryptoDetails(String id, String name, String symbol, String rank, String priceUsd, String priceBtc, String _24hVolumeUsd, String marketCapUsd, String availableSupply, String totalSupply, Object maxSupply, String percentChange1h, String percentChange24h, String percentChange7d, String lastUpdated) {
            super();
            this.id = id;
            this.name = name;
            this.symbol = symbol;
